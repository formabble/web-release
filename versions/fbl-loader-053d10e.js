...
import FblModule from "./fbl-053d10e.js";
const binaryPath = "https://app-bin.formabble.com/fbl-053d10e.wasm";
...
const OPFS_MODE_PERSIST_ALL = 0;
const OPFS_MODE_PERSIST_ASSETS_ONLY = 1;
const OPFS_MODE_NO_PERSIST = 2;
...
async function bootFbl() {
  ...
  let cache = urlQuery["cache"];
  if (typeof (cache) === "number") {
    mod.fblSetOPFSMode(fbl, cache);
  } else {
    mod._fblSetOPFSMode(fbl, OPFS_MODE_PERSIST_ASSETS_ONLY);
  }
