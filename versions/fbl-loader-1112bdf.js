...
import FblModule from "./fbl-1112bdf.js";
const binaryPath = "https://app-bin.formabble.com/fbl-1112bdf.wasm";
...
// If the app is not installed, we can set a timeout to redirect somewhere else.
setTimeout(() => {
  // window.location.href = 'https://yourappwebsite.com';
}, 2000);
